  ...
  const menuItems = [
    {
      ...
      action: () => window.open('https://t.me/+8iOD_GrF-OFiYTJh', '_blank'),
    },
    {
      icon: '𝕏',
      label: 'Follow X',
      description: 'Follow for updates.\nMemes daily.\n@0xwasteland',
      action: () => window.open('https://x.com/0xwasteland', '_blank'),
    },
    {
      icon: '💩',
      label: 'WTF is this?',
        ...
        return (
          <div className="ds-boot-logo">
            <div className="boot-logo-text">
              <span className="boot-shit">shit</span>
              <span className="boot-post">post</span>
              <span className="boot-dot">.pro</span>
            </div>
...
function HomeMenuTopScreen({ item }) {
  return (
    <div className="ds-home-top">
      ...
      <div className="ds-mascot">💩</div>
      <div className="ds-brand">
        <span className="brand-shit">shit</span>
